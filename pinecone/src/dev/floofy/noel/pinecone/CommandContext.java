...
public interface CommandContext {
    ...
    /// Forwarded method:
    // [`SlashCommandInteraction#deferReply()`][SlashCommandInteraction#deferReply()]
    @NotNull
    @CheckReturnValue
    ...
    /// Forwarded method:
    // [`SlashCommandInteraction#deferReply(boolean)`][SlashCommandInteraction#deferReply(boolean)]
    @NotNull
    @CheckReturnValue
    ...
    /// Forwarded method:
    // [`SlashCommandInteraction#reply(String)`][SlashCommandInteraction#reply(String)]
    @NotNull
    @CheckReturnValue
    ...
    /// Forwarded method:
    // [`SlashCommandInteraction#reply(MessageCreateData)`][SlashCommandInteraction#reply(MessageCreateData)]
    @NotNull
    @CheckReturnValue
    ...
    /// Forwarded method: [`SlashCommandInteraction#reply(String,
    // Object...)`][SlashCommandInteraction#reply(String, Object...)]
    @NotNull
    @CheckReturnValue
    ...
    /// Forwarded method: [`SlashCommandInteraction#reply(Collection<? extends
    // MessageEmbed>)`][SlashCommandInteraction#replyEmbeds(Collection<? extends MessageEmbed>)]
    @NotNull
    @CheckReturnValue
    ...
    /// Forwarded method: [`SlashCommandInteraction#replyEmbeds(MessageEmbed,
    // MessageEmbed...)`][SlashCommandInteraction#replyEmbeds(MessageEmbed, MessageEmbed...)]
    @NotNull
    @CheckReturnValue
    default ReplyCallbackAction replyEmbeds(
            @NotNull MessageEmbed embed, @NotNull MessageEmbed... embeds) {
