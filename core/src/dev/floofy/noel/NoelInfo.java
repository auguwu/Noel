...
public final class NoelInfo {
    ...
    private static final String BUILD_DATA_PROPERTIES = "/core/build-data.properties";
    ...
    private static void loadProperties() {
        ...
        try (var stream = NoelInfo.class.getResourceAsStream(BUILD_DATA_PROPERTIES)) {
            if (stream == null) {
