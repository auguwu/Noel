...
package dev.floofy.noel.modules.logging;
 ...
 *
 * <ul>
 *     <li><code>NOEL_LOGBACK_CONFIG_FILE</code> environment variable</li>
 *     <li><code>dev.floofy.noel.logback.config</code> system property</li>
 ...
 * <ul>
 *     <li><code>noel.log.level</code> is set to INFO</li>
 *     <li>JSON logging is enabled, not prettified console output</li>
 * </ul>
 */
public class LogbackConfigurator extends ContextAwareBase implements Configurator {
    private static final String ENVIRONMENT_VARIABLE_NAME = "NOEL_LOGBACK_CONFIG_FILE";
    private static final String SYSTEM_PROPERTY_NAME = "dev.floofy.noel.logback.config";
    ...
    public ExecutionStatus configure(LoggerContext context) {
        ...
        context.putProperty("noel.log.level", "INFO");
        context.putProperty("noel.console.json", "yes");
